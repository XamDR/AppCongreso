...
import org.grupotres.appcongreso.util.doOnEachNextLayout

class StickyHeaderDecoration(parent: RecyclerView,
	private val isHeader: (itemPosition: Int) -> Boolean) : RecyclerView.ItemDecoration() {
